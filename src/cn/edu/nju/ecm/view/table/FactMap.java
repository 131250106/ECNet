...
public class FactMap implements CMap {
	private Object[][] data;
	private ECModel model;
	
	public FactMap(Object[][] data,ECModel model){
		this.data = data;
		this.model = model;
	}
	public int span(int row, int column) {
		...
		if(isSpan(column)){
			...
			CanvasElement connector = model.getElementByID(id);
			return connector.getDegree()+1;
		}
		return 1;
	}
